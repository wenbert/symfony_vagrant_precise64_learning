...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/src/Acme/TaskBundle/Entity')), 'Acme\\TaskBundle\\Entity');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/src/Acme/TaskBundle/Resources/views', 'AcmeTask');
